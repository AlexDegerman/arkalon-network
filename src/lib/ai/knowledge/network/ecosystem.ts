...
5. ARKALON AI (The Oracle)
  ...
  - Features: Ecosystem telemetry analysis, game recommendation triage, 3-turn consultation cycles.
  - Status: ONLINE (Accessible via /ai)
...
The directory supports instant filtering across 8 distinct gameplay categories:
- ALL: Complete catalog.
- LIVE: Currently playable deployments (ONLINE status).
- MULTIPLAYER & CO-OP: Realms, Party, Arena, Raids, Auction.
- INCREMENTAL & IDLE: Labs, Chaos Racing, Colony, Dreadwood, Dispatch.
- STRATEGY & TACTICAL: TD, Market, Dungeons, Arena, Raids, Dispatch.
- ROGUELIKE & RPG: Realms, Dungeons, Dispatch.
- ARCADE & RACING: RPS League, Chaos Racing.
- PUZZLE & LOGIC: Arkalon Daily.
`
